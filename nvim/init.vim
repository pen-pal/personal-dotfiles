...
set encoding=UTF-8
set foldmethod=indent ""syntax       " set folding based on syntax
...
let g:lsp_settings_filetype_terraform = ['terraform-lsp']
let g:lsp_settings_filetype_terraform = ['dockerfile-language-server-nodejs']
...
nnoremap <silent><nowait> <space>w  :ArgWrap<CR>
...
"lazygit"
nnoremap <silent><nowait> <space>lg :LazyGit<CR>
...
EOF
nnoremap <silent><nowait> <space>dv :DiffviewOpen<CR>

"nvim-blame-line"
nnoremap <silent> <leader>lb :ToggleBlameLine<CR>
